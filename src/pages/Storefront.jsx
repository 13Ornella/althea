...
export default function Storefront(){
    return (
     ...
     <div className="mt-48">
        ...
        <h1 className="font-bold text-5xl text-blue-950 items-center pt-28 pb-10">Bienvenue! Cher administrateur</h1>
      <span className="text-3xl text-blue-950  ">Veillez cliquer sur le boutton ci-dessous pour vous connecter </span> <br /> <br /> <br />
      <br /> <br />
      <Link to={'/login'} className="inline-flex w-full justify-center mb-24 rounded-md bg-teal-600 px-3 py-2 text-2xl font-semibold text-white shadow-sm hover:bg-blue-950 sm:ml-3 sm:w-auto "> 
      Se connecter </Link>
     </div>
